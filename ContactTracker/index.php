...
if(isset($_SESSION['user'])){
    ...
    if(check_sess($_SESSION['user'])){
        ...
        <form action="removeFacility.php" method="post" id="deleteField" class="input-group mb-3 mt-3 mr-5" style="width: 300px; float: right;">
            <input type="text" class="form-control" name="deleteField" placeholder="Enter the facility name" aria-label="Recipients username">
    ...
    echo '<form class="no-print" action="suggest.php">
            <button class="btn addbtn d-flex justify-content-end pr-0 pt-0">
                <img width="80" height="80" src="images/pencil.png" alt="suggest an edit">
            </button>
        </form>';
}
